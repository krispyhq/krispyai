...
import type { AnalyticsEvent, EventProps } from "@krispy/analytics/events";
...
// (libs/auth's signup hook keeps its own twin; extract @krispy/analytics on a 3rd.)
 ...
 * shared catalog: the event name + payload must match @krispy/analytics/events.
 */
