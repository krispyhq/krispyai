// @krispy/payment — Creem checkout + webhooks (Hono).
...
// PORT is injected by portless in local dev (payment.krispy.localhost:1355);
// falls back to 3002 for standalone `bun --filter @krispy/payment dev`.
