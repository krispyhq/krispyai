import { Badge, Card, CardContent, CardHeader, CardTitle } from "@krispy/ui";
...
// (`import type` erases at build: the browser never pulls zod/@krispy/api-types.)
import type { Post } from "@krispy/api-types";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          <code>apps/web</code> → <code>@krispy/api</code> at <code>{API_URL}/health</code>
        </p>
      </div>
        ...
        <CardContent>
          <pre className="overflow-x-auto rounded-md bg-muted p-4 text-sm text-muted-foreground">
            {health.reachable
              ...
              : `Could not reach the API.\n${health.error}\n\nStart it with ./tilt_up.sh (or: bun --filter @krispy/api dev).`}
          </pre>
        </CardContent>
      </Card>
