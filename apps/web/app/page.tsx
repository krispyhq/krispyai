...
// This route's canonical metadata — one door (@krispy/seo). Layout owns the site
// default + `%s` template; this pins the "/" canonical + OG for the home route.
export const metadata = pageMetadata({
  title: "Design system",
  description:
    "One design system, every surface — @krispy/ui components and shared tokens rendered by both web and native, wired to a live Better Auth login.",
  path: "/",
});

// Proves the JS token layer is shared: these swatches are driven by @krispy/ui's `tokens`
