...
// This page's canonical metadata — one door (@krispy/seo). The layout sets the site
...
const FEATURES = [
  ...
  },
  {
    ...
    body: "@krispy/ui ships shadcn components + shared tokens. Web and native render the exact same brand.",
  },
  {
