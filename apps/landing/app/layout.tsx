...
// the `%s — Builder's Stack` title template from @krispy/config. No hand-rolled OG here.
...
// by @krispy/seo. Per Google's AI guide this is for rich results, not an AI ranking lever.
