...
description: "Why krispyai splits code by who consumes it — not by feature or by tech — and how that one rule stopped us from restructuring the repo every quarter."
date: "2026-06-24"
updatedAt: "2026-07-02"
author: "The krispyai team"
...
- **`libs/`** — shared code imported by package name, never a deep path. `@krispy/ui`,
  `@krispy/db`, `@krispy/seo`, `@krispy/config`. If more than one app or service needs it,
  it's a lib.
