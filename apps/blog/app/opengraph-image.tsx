...
import { brand, colors } from "@krispy/ui/tokens";

// The default 1200×630 social card for the blog index (and any route without its own
// card). On-brand via the shared @krispy/ui tokens — same palette the app renders.
...
export default function OgImage() {
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ fontSize: 24, color: brand[300] }}>krispyai</div>
    </div>,
    { ...size },
  );
}
