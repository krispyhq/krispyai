// Client door for @krispy/analytics — pulls the "use client" provider, so use this
// from app UI only. The isomorphic event catalog + typed `track` are re-exported here
// for client convenience; SERVER code must import them from "@krispy/analytics/events"
