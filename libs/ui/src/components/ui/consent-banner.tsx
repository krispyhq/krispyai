...
// choice, start/stop trackers) lives in @krispy/analytics' <ConsentBanner/>, which renders
// this with real handlers. Keeping this pure keeps @krispy/ui free of any analytics dep.
