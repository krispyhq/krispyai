// @krispy/config — the single typed door to environment.
//
...
export const EnvSchema = z.object({
  ...
  // Public site identity — the single source @krispy/seo's pageMetadata() reads for
  ...
  // Server-side PostHog (optional — absent = analytics no-op, see @krispy/analytics).
...
// The site identity door for @krispy/seo — name + canonical origin from one place.
